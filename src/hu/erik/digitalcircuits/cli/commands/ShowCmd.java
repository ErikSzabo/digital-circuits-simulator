...
public class ShowCmd extends Command {
    ...
    public void action(DeviceMap storage, String[] cmd) throws NotEnoughArgsException {
        ...
        try {
            ...
            switch (cmd[1]) {
                case "input":
                    System.out.println(cmd[2] + " inputpin(" + cmd[3] +"): " + device.getInputPin(Integer.parseInt(cmd[3])));
                    break;
                case "output":
                    System.out.println(cmd[2] + " outputpin(" + cmd[3] +"): " + device.getInputPin(Integer.parseInt(cmd[3])));
                    break;
                default:
